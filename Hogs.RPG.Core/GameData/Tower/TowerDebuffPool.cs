...
namespace Hogs.RPG.Core.GameData.Tower
{
    ...
    public static class TowerDebuffPool
    {
        public static readonly List<TowerDebuffDefinition> All = new()
        {
            ...
            new() { Type = TowerDebuffType.Weakened,  Emoji = "😵", Name = "Weakened",  Description = "Deal 20% less damage",                               DefaultDuration = -1 },
            new() { Type = TowerDebuffType.Shackled,  Emoji = "🔗", Name = "Shackled",  Description = "Cannot use Rest at the next checkpoint",              DefaultDuration =  1 },
