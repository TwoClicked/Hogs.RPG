// Separate non-grouped class for all trail button interactions
// Component interactions must not be inside a [Group] module
using Discord;
...
public class TrailInteractionModule : InteractionModuleBase<SocketInteractionContext>
{
    ...
    // =========================
    // SHOW SHOP (moved here from TrailModule)
    // =========================
